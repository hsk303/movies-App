...
class Table extends React.Component {
    ...
    render() {
        ...
        let starting = (this.state.CurrentPage - 1) * 5;
        let ending = (this.state.CurrentPage * 5) - 1;
        let moviesToShow = moviesToDisplay.slice(starting, Math.min(ending, moviesToDisplay.length - 1) + 1);
        return (
            ...
            <div>
                        ...
                        {moviesToShow.map((el) => {
                            return (
                                <tr key={el._id}>
                                    ...
                                    <td onClick={()=>{let allMovies= this.state.allMovies;
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" onClick={()=>{let allMovies= this.state.allMovies;
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        {arr.map((el) => {
                            return (
                                <li class="page-item" onClick={() => { this.setState({ CurrentPage: el }) }}><a class="page-link" href="#">{el}</a></li>
                            );
                        })}
